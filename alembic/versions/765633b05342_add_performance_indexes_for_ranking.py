...
def upgrade() -> None:
    ...
    op.create_index(
        'ix_contest_isscholarship',
        'contest',
        ['isScholarship'],
        unique=False
    )
    op.create_index(
        'ix_contest_ends_at_created_at',
        'contest',
        ['ends_at', 'created_at'],
        unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index('ix_questionattempt_created_at', table_name='question_attempts')
    ...
    op.drop_index('ix_contest_ends_at_created_at', table_name='contest')
    op.drop_index('ix_contest_isscholarship', table_name='contest')
